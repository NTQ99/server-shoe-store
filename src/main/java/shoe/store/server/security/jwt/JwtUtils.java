package shoe.store.server.security.jwt;
...
import shoe.store.server.security.services.UserDetailsImpl;

@Component
public class JwtUtils {
	private static final Logger logger = LoggerFactory.getLogger(JwtUtils.class);

	@Value("${shoe.store.jwtSecret}")
	private String jwtSecret;

	@Value("${shoe.store.jwtExpirationMs}")
